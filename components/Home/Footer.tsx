      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <img className="w-64" src="/images/logo with text.png" alt="" />
            ...
            <form action="#" method="POST" className="mt-6">
              <div>
                ...
                <input
                  ...
                  className="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-primary
                         caret-primary"
                />
              </div>
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center px-6 py-3 mt-3 font-semibold text-white bg-gradient-to-l from-primary to-secondary rounded-xl bg-animation"
              >
                Subscribe
              </button>
            </form>
        ...
        <hr className="mt-16 mb-10 border-secondary/60" />
