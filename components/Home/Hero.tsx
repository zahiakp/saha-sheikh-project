        ...
        <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
            <div className="flex items-center justify-between">
                <div className="flex flex-shrink-0">
                    <a href="/"  className="inline-flex rounded-md ">
                        <img className="w-auto h-[70px]" src="/images/logo with text white.png" alt="Saha Sheikh Ahmed" />
                    </a>
                </div>
    ...
    <div className="relative">
        <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
            <div className="w-full lg:w-2/3 xl:w-1/2">
                <h1 className="font-sans text-base font-normal tracking-tight text-white text-opacity-70">Master the basics of Knowledge</h1>
                <p className="mt-6 tracking-tighter text-white">
                    <span className="font-sans font-normal text-7xl">The root to the</span><br />
                    <span className="font-serif italic font-normal text-8xl">perfect Way</span>
                </p>
                ...
                {/* <p className="mt-8 font-sans text-xl font-normal text-white">Know more about me</p> */}
